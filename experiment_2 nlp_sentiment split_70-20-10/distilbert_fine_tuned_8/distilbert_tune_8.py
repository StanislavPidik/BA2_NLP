...
def plot_history(history):
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig('./distilbert_fine_tuned_8/loss.png')
    ...
    plt.ylabel('Accuracy')
    plt.legend()
    plt.savefig('./distilbert_fine_tuned_8/accuracy.png')
    plt.show()

plot_history(history)

model.save_pretrained('./distilbert_fine_tuned_8')
